 ...
 */
@UriEndpoint(scheme = "call", title = "CALL", syntax = "call:httpUri", producerOnly = true, label = "http", lenientProperties = true)
public class CallEndpoint extends DefaultEndpoint implements HeaderFilterStrategyAware {
    ...
    public CallEndpoint(String endpointUri, CallComponent component, URI httpUri) {
    ...
    public CallComponent getComponent() {
        return (CallComponent) super.getComponent();
    }
    ...
    public Producer createProducer() throws Exception {
        ...
        ObjectHelper.notNull(binding, "Binding", this);
        return new CallProducer(this);
    }
    ...
    protected void doStart() throws Exception {
        ...
        if (client == null) {
            ...
            if (clientConfig != null) {
                AsyncHttpClientConfig.Builder builder = CallComponent.cloneConfig(clientConfig);
