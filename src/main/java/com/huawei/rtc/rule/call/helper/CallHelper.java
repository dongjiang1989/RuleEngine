package com.huawei.rtc.rule.call.helper;
...
public class CallHelper {
     ...
     */
    public static String createURL(Exchange exchange, CallEndpoint endpoint) throws URISyntaxException, UnsupportedEncodingException {
        String url = doCreateURL(exchange, endpoint);
        return URISupport.normalizeUri(url);
    }

    private static String doCreateURL(Exchange exchange, CallEndpoint endpoint) {
        String uri = null;
     ...
     */
    public static URI createURI(Exchange exchange, String url, CallEndpoint endpoint) throws URISyntaxException {
        URI uri = new URI(url);
